<div>
    ...
    <form wire:submit="save">
        <div class="w-full flex flex-col items-center mb-8">
            <label for="imageUpload" class="cursor-pointer group flex flex-col items-center">
                <div
            ...
            {{ $errors->has('image') ? 'border-red-500' : 'border-transparent group-hover:border-blue-400' }}">
                    ...
                    @endif
                    <div
                        class="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 bg-black/40 transition-opacity duration-300 rounded-full">
        ...
        <div class="mt-8 mx-auto bg-white p-6 rounded-xl shadow-lg border border-gray-100">
            ...
            <div>
                <label for="subtitle" class="block text-sm font-semibold text-gray-700 mb-2">Sous-titre</label>
